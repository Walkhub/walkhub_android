...
class UserRepositoryImpl @Inject constructor(
    ...
    override suspend fun postUserSignIn(
        ...
        emit(remoteChallengeDateSource.postUserSignIn(postUserSignInParam.toRequest()).toEntity())
    }

    override suspend fun patchUserChangePassword(
        patchUserChangePasswordParam: PatchUserChangePasswordParam
    ) = remoteChallengeDateSource.patchUserChangePassword(patchUserChangePasswordParam.toRequest())
